...
const CastIron = require("./CastIronAPI.js");

const F = require("./libs/Functional.js");
const ciapi = new CastIron(1100);
...
// returns prebind ABI contract instance for tokens
// this version is a temporary version using info set
// by current Cast-Iron code.
const registry = () => { return { 'TKA': {'ABI': ciapi.T, '11BE': ciapi.B } } };
const tokenInfo = symbol => { return registry[symbol]; };
